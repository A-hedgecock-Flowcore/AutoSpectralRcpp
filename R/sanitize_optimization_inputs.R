...
#' @title Sanitize Optimization Inputs for C++
#'
#' @description
...
#' The aim is prevent hard crashes in the C++ code, which can be triggered by NA,
#' NaN (divide by zero) or empty list elements.
#'
